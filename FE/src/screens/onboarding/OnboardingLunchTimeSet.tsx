...
type NavigationProp = NativeStackNavigationProp<RootStackParamList, 'OnboardingLunchTimeSet'>;

const timeOptions = [11, 12, 1, 2, 3, 4];

export default function OnboardingLunchTimeSet() {
  ...
  const handleNext = () => {
    if (isNextButtonActive) {
      ...
      navigation.navigate('OnboardingEveningTimeSet');
    }
  };
