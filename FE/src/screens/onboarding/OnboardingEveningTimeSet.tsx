...
type NavigationProp = NativeStackNavigationProp<RootStackParamList, 'OnboardingEveningTimeSet'>;

const timeOptions = [4, 5, 6, 7, 8, 9];

export default function OnboardingEveningTimeSet() {
  ...
  const handleNext = () => {
    if (isNextButtonActive) {
      console.log('선택된 저녁 약 시간:', selectedTime);
      navigation.navigate('OnboardingBedTimeSet');
    }
  };
