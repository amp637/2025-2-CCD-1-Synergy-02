...
interface PrescriptionLunchTimeEditScreenProps {
  umno: number;
  onNext?: () => void;
}

export default function PrescriptionLunchTimeEditScreen({ umno, onNext }: PrescriptionLunchTimeEditScreenProps) {
