...
interface PrescriptionEveningTimeEditScreenProps {
  umno: number;
  onNext?: () => void;
}

export default function PrescriptionEveningTimeEditScreen({ umno, onNext }: PrescriptionEveningTimeEditScreenProps) {
