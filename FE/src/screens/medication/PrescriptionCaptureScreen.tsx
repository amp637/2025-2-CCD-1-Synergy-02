...
type NavigationProp = NativeStackNavigationProp<RootStackParamList, 'PrescriptionCapture'>;
...
export default function PrescriptionCaptureScreen() {
  ...
  const handleCapture = async () => {
    ...
    // multipart/form-data로 image 파일 전송
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.guideTextContainer}>
        <Text style={styles.guideText}>처방전을 가이드 안에 맞춰주세요</Text>
      </View>
